...
Payment.prototype.buildXML = function(obj) {
    return util.buildXML(obj);
};

Payment.prototype.parseXML = function(xml, callback) {
    return util.parseXML(xml, callback);
};

Payment.prototype.generateNonceStr = function(length) {
    return util.generateNonceStr(length);
};
